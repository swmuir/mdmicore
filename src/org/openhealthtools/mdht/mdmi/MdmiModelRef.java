...
public final class MdmiModelRef {
    ...
    * 
    * @param qualifiedName The qualified mdoel name, formatted as 'groupName.messageName'.
    */
    ...
    * 
    * @param groupName The MessageGroup name.
    * @param modelName The MessageModel name.
    */
   ...
   public void resolve() {
      ...
      System.out.println("Resolved model ref: '" + m_groupName + "." + m_modelName + "'.");
   }

   @Override
   public String toString() {
      return m_groupName + "." + m_modelName + "[isResolved=" + (isResolved() ? "true" : "false");
   }
} // MdmiModelRef

...
public final class DTSPrimitive extends DTSimple {
	public static final DTSPrimitive BINARY   = new DTSPrimitive( "Binary"  , "Binary"  , "http://www.w3.org/2001/XMLSchema#hexBinary" );
	public static final DTSPrimitive BOOLEAN  = new DTSPrimitive( "Boolean" , "Boolean" , "http://www.w3.org/2001/XMLSchema#boolean" );
	public static final DTSPrimitive DATETIME = new DTSPrimitive( "DateTime", "DateTime", "http://www.w3.org/2001/XMLSchema#dateTime" );
	public static final DTSPrimitive DECIMAL  = new DTSPrimitive( "Decimal" , "Decimal" , "http://www.w3.org/2001/XMLSchema#decimal" );
	public static final DTSPrimitive INTEGER  = new DTSPrimitive( "Integer" , "Integer" , "http://www.w3.org/2001/XMLSchema#integer" );
	public static final DTSPrimitive STRING   = new DTSPrimitive( "String"  , "String"  , "http://www.w3.org/2001/XMLSchema#string"   );
	...
	public static final DTSPrimitive[] ALL_PRIMITIVES = 

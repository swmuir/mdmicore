...
/**
 * A choice data type is a named type consisting of one choice from two or more possible fields. Each field has a type:
 * either primitive type, or a Datatype. It also has a multiplicity, expressed as min-max no of occurrences.
 */
public final class DTCChoice extends DTComplex {
   ...
   protected void toString( StringBuffer out, String indent ) {
      out.append(indent + "Choice datatype: " + m_name + "\r\n");
      indent += "  ";

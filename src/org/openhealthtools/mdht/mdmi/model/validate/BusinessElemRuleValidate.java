...
public class BusinessElemRuleValidate implements IModelValidate<MdmiBusinessElementRule> {
   ...
   @Override
   public void validate( MdmiBusinessElementRule object, ModelValidationResults results ) {

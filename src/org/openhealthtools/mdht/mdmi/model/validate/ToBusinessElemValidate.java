...
public class ToBusinessElemValidate extends ConversionRuleValidate<ToBusinessElement> {
   public static final String s_busElemField = "businessElement";

   @Override
   public void validate( ToBusinessElement object, ModelValidationResults results ) {

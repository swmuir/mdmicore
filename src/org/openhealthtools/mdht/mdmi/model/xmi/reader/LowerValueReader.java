...
public class LowerValueReader extends XMIReaderAbstract<LimitValue> {
   private static final String s_elemName = "lowerValue";
   ...
   protected void readAttributes( XMLStreamReader reader, LimitValue object ) {
      ...
      if( value == null || value.length() == 0 || value.equals("*") ) {
         ...
         try {
            ...
            throw new IllegalArgumentException("Unable to parse lower limit of '" + value + "'.", exc);
         }
      }
   }

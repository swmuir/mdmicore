...
public class CSVConversionRuleToReader implements ICSVRowReader  {
   public static final String s_refName = "TRRef";
   public static final String s_ruleName = "toMdmi";
   public static final String s_busElemName = "toBusinessElement";
   public static final String s_ruleAttribName = "rule";
   public static final String s_busElemRefName = "businessElement";
   
   @Override
   public void readRow(CsvReader reader, RawRoot root,
         HashMap<String, ClassDef> singletonMap, LinkedList<ItemInfo> stack)
         throws IOException {
      ...
      CSVReaderUtil.createStereotype(StereotypeNames.TO_MESSAGE_ELEMENT, def, root);

...
public class MdmiException extends RuntimeException {
    ...
    * "someFile.txt"
    * 
    * @param message The exception message. May contain parameter place-holders.
    * @param params An array of parameters used as replacements in the message.
    */
    ...
    * 
    * @param cause The caught exception that caused this instance to be created
    * @param message The exception message.
    */
    ...
    * 
    * @param ex Exception for which the description is built.
    ...
    * 
    * @param sb String buffer to place the description into.

...
public class XPathParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'or'", "'!='", "'and'", "'$'", "'='", "'processing-instruction'", 
		"'div'", "'mod'", "'/'", "'//'", "'('", "')'", "'['", "']'", "'-'", "'+'", 
		"'.'", "'*'", "'..'", "'@'", "','", "'|'", "'<'", "'>'", "'<='", "'>='", 
		"':'", "'::'", "'''", "'\"'", "NodeType", "Number", "AxisName", "Literal", 
		"Whitespace", "NCName"
	};
	public static final int
	...
	public final LocationPathContext locationPath() throws RecognitionException {
		...
		try {
			...
			case NCName:
				enterOuterAlt(_localctx, 1);
				{
				setState(56); relativeLocationPath();
				}
				break;
			case PATHSEP:
			case ABRPATH:
				...
				{
				setState(57); absoluteLocationPathNoroot();
				}
				break;
			default:
	...
	public final AbsoluteLocationPathNorootContext absoluteLocationPathNoroot() throws RecognitionException {
		...
		try {
			...
			case PATHSEP:
				enterOuterAlt(_localctx, 1);
				{
				setState(60); match(PATHSEP);
				setState(61); relativeLocationPath();
				}
				break;
			case ABRPATH:
				enterOuterAlt(_localctx, 2);
				{
				setState(62); match(ABRPATH);
				setState(63); relativeLocationPath();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final StepContext step() throws RecognitionException {
		...
		try {
			...
			case NCName:
				enterOuterAlt(_localctx, 1);
				{
				setState(74); axisSpecifier();
				setState(75); nodeTest();
				setState(79);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==LBRAC) {
	...
	public final AxisSpecifierContext axisSpecifier() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(85); match(AxisName);
				setState(86); match(CC);
				}
				break;
	...
	public final NodeTestContext nodeTest() throws RecognitionException {
		...
		try {
			...
			case NCName:
				enterOuterAlt(_localctx, 1);
				{
				setState(92); nameTest();
				}
				break;
			case NodeType:
				enterOuterAlt(_localctx, 2);
				{
				setState(93); match(NodeType);
	...
	public final PredicateContext predicate() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(102); match(LBRAC);
			setState(103); expr();
			setState(104); match(RBRAC);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PrimaryExprContext primaryExpr() throws RecognitionException {
		...
		try {
			...
			case 4:
				enterOuterAlt(_localctx, 1);
				{
				setState(110); variableReference();
				}
				break;
			case LPAR:
				enterOuterAlt(_localctx, 2);
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(120); functionName();
			setState(121); match(LPAR);
			setState(130);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << PATHSEP) | (1L << ABRPATH) | (1L << LPAR) | (1L << MINUS) | (1L << DOT) | (1L << MUL) | (1L << DOTDOT) | (1L << AT) | (1L << NodeType) | (1L << Number) | (1L << AxisName) | (1L << Literal) | (1L << NCName))) != 0)) {
				{
				setState(122); expr();
				setState(127);
				_errHandler.sync(this);
	...
	public final UnionExprNoRootContext unionExprNoRoot() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(134); pathExprNoRoot();
				setState(137);
				_la = _input.LA(1);
				if (_la==PIPE) {
					{
					setState(135); match(PIPE);
					setState(136); unionExprNoRoot();
					}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(139); match(PATHSEP);
				setState(140); match(PIPE);
				setState(141); unionExprNoRoot();
				}
				break;
			}
		}
		...
		try {
			...
			case 2:
				...
				if (_la==PATHSEP || _la==ABRPATH) {
					...
					consume();
					setState(147); relativeLocationPath();
					}
				}
	...
	public final AdditiveExprContext additiveExpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(191); multiplicativeExpr();
			setState(196);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==MINUS || _la==PLUS) {
				...
				consume();
				setState(193); multiplicativeExpr();
				}
				}
				setState(198);
				_errHandler.sync(this);
		...
		try {
			...
			case 1:
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 7) | (1L << 8) | (1L << MUL))) != 0)) {
					...
					consume();
					setState(201); multiplicativeExpr();
					}
				}
			...
			case 2:
				...
				if (_la==7 || _la==8) {
					...
					consume();
					setState(206); multiplicativeExpr();
					}
				}

...
/**
 * Internal class, defines a conversion for a transfer request, within a unit of work. 
 * 
 * @author goancea
 */
class Conversion {
   ...
   /**
    * Construct a ConversionInfo for each element in the m_transferInfo.targetElements.
    * The names in the m_transferInfo.targetElements are target BusinessElementRefecence names. 
    * 
   ...
   /**
    * Construct a ConversionInfo for each element in the m_transferInfo.targetElements.
    * The names in the m_transferInfo.targetElements are target SemanticElement names. 
    * 
    * @param elements The elements to use, a list of strings.
    */
   ...
   // given a BER get a list of all SEs that have a ToBusinessElement rule for it
   ...
   // given a BER get a list of all SEs that have a ToMessageElement rule for it
   // and if none get a name match
   ...
   /**
    * Each instance of this class wraps one conversion, from one source SE to one or more target SEs,
    * through a source and target BER.
    * 
    * @author goancea
    */
   static class ConversionInfo implements ICloneable<ConversionInfo> {
      SemanticElement              target; // target message element
      MdmiBusinessElementReference trgBER; // target business element reference
      MdmiBusinessElementReference srcBER; // source business element reference (same unique ID as target)
      ArrayList<SemanticElement>   source; // source message elements
      
      public ConversionInfo( SemanticElement              target, 
                             MdmiBusinessElementReference trgBER, 

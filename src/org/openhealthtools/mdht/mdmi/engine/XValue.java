...
/**
 * A semantic value (a field). It has a name, datatype and the actual value or values.
 * It may be owned by an element value, or by one of the structured semantic type (XDataStruct or XDataChoice).
 * 
 * @author goancea
 */
public final class XValue implements IValue {
    ...
    *  
    * @param owner The element owner, may not be null.
    */
    ...
    * 
    * @param owner The owner structure or choice.
   ...
   /**
    * For stand alone values we add the fields, if the type is a structure or choice.
    */
    ...
    * @param deep If deep is true, it will clone all child values, otherwise just the references.
    */

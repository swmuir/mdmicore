...
public class ConvertToFactory {
   // Map of converters
   private static final HashMap<DTSPrimitive, HashMap<XDT, IConvertToString>> CONVERT_MAP
         = new HashMap<DTSPrimitive, HashMap<XDT, IConvertToString>>();
   ...
   private static final ConstrainedIntegerConverter CONV_UINT      = new ConstrainedIntegerConverter(BigInteger.ZERO,
                                                                         new BigInteger("4294967295"));
   private static final ConstrainedIntegerConverter CONV_ULONG     = new ConstrainedIntegerConverter(BigInteger.ZERO,
   ...
   public IConvertToString getConverter( XDT toType, DTSPrimitive fromType ) {
      HashMap<XDT, IConvertToString> fromMap = CONVERT_MAP.get(fromType);
   ...
   private ConvertToFactory() {
      ...
      CONVERT_MAP.put(DTSPrimitive.INTEGER, local);
      ...
      CONVERT_MAP.put(DTSPrimitive.DECIMAL, local);
      local.put(XDT.BASE64BINARY, CONV_BASE64);
      ...
      /*********** Boolean *****************/
      local = new HashMap<XDT, IConvertToString>();
      CONVERT_MAP.put(DTSPrimitive.BOOLEAN, local);
      local.put(XDT.BASE64BINARY, CONV_BASE64);
      ...
      /*********** Binary *****************/
      local = new HashMap<XDT, IConvertToString>();
      CONVERT_MAP.put(DTSPrimitive.BINARY, local);
      ...
      /*********** String *****************/
      local = new HashMap<XDT, IConvertToString>();
      CONVERT_MAP.put(DTSPrimitive.STRING, local);
      ...
      /*********** DateTime *****************/
      local = new HashMap<XDT, IConvertToString>();
      CONVERT_MAP.put(DTSPrimitive.DATETIME, local);

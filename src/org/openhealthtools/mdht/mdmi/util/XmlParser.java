...
public final class XmlParser {
    ...
    * 
    * @param strict Treat parse errors as fatal errors (default value is TRUE)
    * @param coalescing Coalesce adjacent text and CDATA nodes (default value is FALSE)
    * @param expandEntityReferences Expand entity references (default value is TRUE)
    * @param ignoreComments Ignore comments (default value is FALSE)
    * @param ignoreElementWhitespace Igrore whitespace in element content (default value is FALSE)
    * @param namespaceAware Use namespaces (default value is TRUE)
    * @param validating Use validation (default value is FALSE)
    */
   ...
   public String getMessages() {
      ...
      for( int i = 0; i < m_messages.size(); i++ ) {
         if( i > 0 )
            msgs.append('\n');
         msgs.append((String)m_messages.get(i));
      }
    ...
    * 
    * @param uri The XML document file.
    ...
    * 
    * @param reader The XML document character reader.
    * @return The DOM Document.
    */
    ...
    * 
    * @param uri The XML document location URI.
    * @return The DOM Document.
    */

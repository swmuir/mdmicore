...
public class StringUtil {
    ...
    * 
    * @param s Clear-text to be encoded
    ...
    * 
    * @param z The string encoded as "A0B302..."
    * @return The clear-text bytes
    */
    ...
    * 
    * @param a Clear-text bytes to be encrypted and encoded
    * @return The encoded string
    */
   ...
   public static String getString( byte[] a, String enc ) {
      if( a == null )
         throw new IllegalArgumentException("null argument in Util.getString()");
      if( a.length <= 0 )
         return "";
      if( enc == null )
         enc = "UTF-8";
    ...
    * 
    * @param src The source string, may not be null.
    * @param len The length of the padded string to return.
    * @param fill The character to use to for padding.

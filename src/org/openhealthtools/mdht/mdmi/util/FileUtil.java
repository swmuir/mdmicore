...
public final class FileUtil {
    ...
    * 
    * @param f The file to read
    * @param enc Encoding to use, if null will use UTF-8.
    * @return The contents of the file as string.
    */
    ...
    * @param s The contents of the file as string.
    */
    ...
    * @param f The file to write to.
    * @param s The contents of the file as string.
    * @param backup If true and the file exists, it will be backed up.
    */
    ...
    * @param trg File Target directory.
    * @return True if the copy succeeded, false otherwise.
    */
   ...
   public static boolean emptyFolder( File dir ) {
      ...
      if( !dir.isDirectory() )
         throw new IllegalArgumentException("Invalid path " + dir.getAbsolutePath()
    ...
    * 
    * @param s Incoming string to be verified.
    ...
    * 
    * @param base The prefix for the file name to use (if not specified, none is used).
    * @param ext File extension to use, if not specified ".tmp" will be used.

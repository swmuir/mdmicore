...
public interface IPreProcessor {
    ...
    * @param isSource If true, this is a source message otherwise this is a target.
    */
   public void processMessage( MdmiMessage message, MdmiModelRef model, boolean isSource );
} // IPreProcessor

...
public interface IValue {
    ...
    * 
    * @param name The new name of the field or value.
    */
    ...
    * 
    * @param src The source for the values.
    */
    ...
    * 
    * @param index The index at which the value is to be removed. Must be valid.
    */
